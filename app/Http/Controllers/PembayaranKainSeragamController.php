...
class PembayaranKainSeragamController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            $query = Transaksi::with('user')->where('tagihan_id', '4');
                    ...
                    <div class="btn-group">
                      <div class="dropdown">
                        ...
                        data-toggle="modal" data-target="#editModal">Edit</button>
                          <form action="' . route('data-tagihan-kainSeragam.destroy', $item->id) . '" method="POST">
        ...
        return view('pages.data-pembayaran-kainseragam', compact('siswa', 'tagihan'));
    }
